...
sim_SIR1$Itr <- rep(1, nrow(sim_SIR1))
## We will make a column called Itr that 
## consists of 2s to say this is the second iteration
sim_SIR2$Itr <- rep(2, nrow(sim_SIR2))
## Combine the two data frames 
sim_SIR <- rbind(sim_SIR1, sim_SIR2)
```

Plot your result. We have used color for compartment using `geom_line(aes(color=compartment))`. You can include information to differentiate between the two simulations:  `geom_line(aes(color=compartment, linetype=Itr))`.
